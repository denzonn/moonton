import PropaTypes from 'prop-types'

MovieCard.protoType = {
  // Apa saja yang diterima
  slug: PropaTypes.string.isRequired,
  name: PropaTypes.string.isRequired,
  category: PropaTypes.string.isRequired,
  thumbnail: PropaTypes.string.isRequired,
}
